  ...
  if (!hasHydrated) {
    return (
      <section className="page-shell pb-20 pt-8">
        <div className="relative overflow-hidden bg-[#071426] p-8 text-white">Loading...</div>
      </section>
    );
  }
      ...
      <div className="relative overflow-hidden bg-[#071426] p-6 text-white shadow-[0_36px_100px_rgba(4,12,30,0.22)] md:p-10">
        ...
        <div className="relative z-10 grid gap-8 lg:grid-cols-[1fr_26rem] lg:items-center">
          <div>
            ...
            <h1 className="display-title mt-4 max-w-3xl text-4xl font-semibold text-white md:text-5xl">
              {title}
            </h1>
            ...
            <div className="relative mt-8 min-h-[12rem] overflow-hidden border border-[rgba(255,255,255,0.12)] md:min-h-[16rem]">
              <Image
              ...
              <p className="absolute bottom-5 left-5 max-w-lg text-lg font-semibold leading-7 text-white">
                Discovery starts after sign-in so the database feels like a private workspace.
              </p>
            </div>
          </div>

          <div className="border border-[rgba(255,255,255,0.14)] bg-[rgba(255,255,255,0.08)] p-5 backdrop-blur-xl">
            ...
            <button
              className="mt-5 w-full bg-[linear-gradient(90deg,#ff8f52_0%,#248cff_100%)] px-5 py-3 text-sm font-semibold text-white shadow-[0_18px_42px_rgba(36,140,255,0.24)] disabled:cursor-not-allowed disabled:opacity-60"
