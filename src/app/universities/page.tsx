...
export default function UniversitiesPage() {
  return (
    <div className="pt-8">
      <section className="page-shell pb-8 pt-6 md:pb-12 md:pt-14">
        <div className="relative overflow-hidden rounded-[1.7rem] border border-[rgba(255,255,255,0.16)] bg-[#081723] p-4 text-white shadow-[0_30px_90px_rgba(8,20,30,0.18)] md:rounded-[2.4rem] md:p-10">
          <Image
          ...
          <div className="relative z-10 grid gap-4 md:gap-8 lg:grid-cols-[1fr_18rem] lg:items-end">
            ...
            <div className="rounded-[1.2rem] border border-[rgba(255,255,255,0.14)] bg-[rgba(255,255,255,0.08)] p-4 backdrop-blur-xl md:rounded-[1.7rem] md:p-5">
              <p className="text-xs uppercase tracking-[0.22em] text-[rgba(255,255,255,0.62)]">Explore opportunities</p>
              <p className="mt-2 text-sm leading-5 text-[rgba(255,255,255,0.8)] md:mt-3 md:leading-6">
